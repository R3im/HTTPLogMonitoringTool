...
public class HTTPLogParserTest {
	...
	public void testParseSuccess() {
		String logRow = "127.0.0.1 - lily [24/11/2222:16:05:35 +0100] \"DELETE /sport/volleyball HTTP/1.0\" 300 8";
		...
		try {
			...
			Assert.assertEquals("Bad ReqDate",DATE_FORMAT.parse("[24/11/2222:16:05:35 +0100]"), row.getReqDate());
	...
	public void testParseFail() {
		...
		try {
			HTTPLogParser.parse(" 127.0.0.1 - lily [24/11/2018:16:05:35 +0100] \"DELETE /sport/volleyball HTTP/1.0\" 300 8");
			Assert.fail("Should throw Exception");
		} catch (HTTPLogRowFormatException e) {
		...
		try {
			HTTPLogParser.parse("127.0.0.1 - lily [24/11/aaa:16:05:35 +0100] \"DELETE /sport/volleyball HTTP/1.0\" 300 8");
			Assert.fail("Should throw Exception");
		} catch (HTTPLogRowFormatException e) {
			Assert.assertTrue("Bad exception: "+e.getMessage(),e.getMessage().equals("ReqDate bad format"));
		}
		try {
			HTTPLogParser.parse("127.0.0.1 - li ly [24/11/2018:16:05:35 +0100] \"DELETE /sport/volleyball HTTP/1.0\" 300 8");
			Assert.fail("Should throw Exception");
		} catch (HTTPLogRowFormatException e) {
			Assert.assertTrue("Bad exception: "+e.getMessage(),e.getMessage().equals("ReqDate bad format"));
		}
		...
		try {
			HTTPLogParser.parse("127.0.0.1 - lily [24/11/2018:16:05:35 +0100] \"DELETE /sport/volleyball HTTP/1.0\" zzz 8");
			Assert.fail("Should throw Exception");
		} catch (HTTPLogRowFormatException e) {
			Assert.assertTrue("Bad exception: "+e.getMessage(),e.getMessage().equals("ReqStatus bad format"));
		}
		try {
			HTTPLogParser.parse("127.0.0.1 - lily [24/11/2018:16:05:35 +0100] \"DELETE /sport/volleyball HTTP/1.0\" 300 gg");
			Assert.fail("Should throw Exception");
		} catch (HTTPLogRowFormatException e) {
			Assert.assertTrue("Bad exception: "+e.getMessage(),e.getMessage().equals("Content length bad format"));
		}
		try {
			HTTPLogParser.parse("127.0.0.1 - lily [24/11/2018:16:05:35 +0100] ");
			Assert.fail("Should throw Exception");
		} catch (HTTPLogRowFormatException e) {
			Assert.assertTrue("Bad exception: "+e.getMessage(),e.getMessage().equals("Bad format"));
		}
		try {
			HTTPLogParser.parse("127.0.0.1 -  [24/11/2018:16:05:35 +0100] \"DELETE /sport/volleyball HTTP/1.0\" 66 8");
			Assert.fail("Should throw Exception");
		} catch (HTTPLogRowFormatException e) {
		...
		try {
			HTTPLogParser.parse("127.0.0.1 - lala [24/11/2018:16:05:35 +0100] \" /sport/volleyball HTTP/1.0\" 66 8");
			Assert.fail("Should throw Exception");
		} catch (HTTPLogRowFormatException e) {
			Assert.assertTrue("Bad exception: "+e.getMessage(),e.getMessage().equals("ReqType is blank"));
		}
		try {
			HTTPLogParser.parse("127.0.0.1 - lily [24/11/2018:16:05:35 +0100] \"DELETE  HTTP/1.0\" 66 8");
			Assert.fail("Should throw Exception");
		} catch (HTTPLogRowFormatException e) {
			Assert.assertTrue("Bad exception: "+e.getMessage(),e.getMessage().equals("ReqResource is blank"));
		}
		try {
			HTTPLogParser.parse("127.0.0.1 - lily [24/11/2018:16:05:35 +0100] \"DELETE /sport/volleyball \" 66 8");
			Assert.fail("Should throw Exception");
		} catch (HTTPLogRowFormatException e) {
			Assert.assertTrue("Bad exception: "+e.getMessage(),e.getMessage().equals("ReqProtocol is blank"));
		}
		try {
			HTTPLogParser.parse("127.0.0.1 - lily [24/11/2018:16:05:35 +0100] \"DELETE /sport/volleyball HTTP/1.0\"  8");
			Assert.fail("Should throw Exception");
		} catch (HTTPLogRowFormatException e) {
			Assert.assertTrue("Bad exception: "+e.getMessage(),e.getMessage().equals("ReqStatus bad format"));
		}
		try {
			HTTPLogParser.parse("127.0.0.1 - lily [24/11/2018:16:05:35 +0100] \"DELETE /sport/volleyball HTTP/1.0\" 66 ");
			Assert.fail("Should throw Exception");
		} catch (HTTPLogRowFormatException e) {
			Assert.assertTrue("Bad exception: "+e.getMessage(),e.getMessage().equals("Bad format"));
		}
